...
import { getOutGoingFriendRequest, getUserFriends, getUserRecommendation, sendFriendRequest } from '../lib/api.js';
...
function HomePage() {
  ...
  const [outGoingRequestState, setOutGoingRequestState] = useState(new Set())
          ...
          {recommendationLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendation.map((user) => {
                const hasRequestBeenSent = outGoingRequestState.has(user._id);
